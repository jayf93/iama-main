...
$(window).ready(() => {
  $('body').prepend(`<div class="row no-margin">
    <div class="col-sm-2 lime-sidebar-main">
      ...
      <div class="container" id="sidebar-text" style="top:20%;">
        <div class="row" data-step="1">
          ...
          <div class="col-sm-10 no-padding pr-4">
            <span class="lime-section-text lime-breadcrumb active" onclick="prepareSwitchRoute('a')">About you</span>
            <div class="lime-about mb-3"></div>
          </div>
        </div>
        <div class="row" data-step="1-b">
          <div class="col-sm-2 no-padding">
            <div class="lime-section lime-ball d-none"></div>
          </div>
          <div class="col-sm-10 no-padding pr-4">
            <span class="lime-section-text lime-breadcrumb inactive">Your location</span>
            <div class="lime-location mb-3"></div>
          </div>
        </div>
        <div class="row" data-step="2">
          ...
          <div class="col-sm-10 no-padding pr-4">
            <span class="lime-section-text lime-breadcrumb inactive">Condition details</span>
            <div class="lime-condition mb-3"></div>
          </div>
        </div>
        <div class="row" data-step="3">
          <div class="col-sm-2 no-padding pr-4">
            <div class="lime-section d-none"></div>
          </div>
          <div class="col-sm-10 no-padding">
            <span class="lime-section-text lime-breadcrumb inactive">Appointment details</span>
            <div class="lime-appointment mb-3"></div>
          </div>
        </div>
      </div>
...
var setEvents = () => {
  aF.events.on('loc', e => {
    console.log('this is the loc step', e)
    initLocationStep();
  })
...
var initLocationStep = () => {
  $('.animate-message-buttons').html(`
        <div class="tabs-menu w-tab-menu mt-4 mb-2">
          <a data-w-tab="Capital Cities" class="tab_main w-inline-block w-tab-link w--current"><div class="text-block-6">CAPITAL CITIES</div></a>
          <a data-w-tab="South East Queensland" class="tab_main w-inline-block w-tab-link"><div class="text-block-6">SOUTH&nbsp;EAST&nbsp;QUEENSLAND</div></a>
          <a data-w-tab="Regional Queensland" class="tab_main w-inline-block w-tab-link"><div class="text-block-6">REGIONAL&nbsp;QUEENSLAND</div></a>
        </div>
        <div class="w-tab-content">
          <div data-w-tab="Capital Cities" class="w-tab-pane w--tab-active" style="opacity: 1; transition: opacity 300ms ease 0s;">
            <div class="location_ist_wrapper w-dyn-list">
              <div class="w-dyn-items w-row">

                <table class="animate-message-buttons-container">
                  <tbody>
                    <tr>
                      <td class="animate-message-td" width="50%">
                        <div>
                          <button class="button animate-message-action-button" data-currentpath="loc" data-text="Adelaide" data-path="post-loc" data-stage="location" data-id="location">Adelaide</button>
                        </div>
                      </td>
                      <td class="animate-message-td" width="49%">
                        <div>
                          <button class="button animate-message-action-button" data-currentpath="loc" data-text="Brisbane" data-path="post-loc" data-stage="location" data-id="location">Brisbane</button>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td class="animate-message-td" width="50%">
                        <button class="button animate-message-action-button" data-currentpath="loc" data-text="Canberra" data-path="post-loc" data-stage="location" data-id="location">Canberra</button>
                      </td>
                      <td class="animate-message-td" width="49%">
                        <button class="button animate-message-action-button" data-currentpath="loc" data-text="Hobart" data-path="post-loc" data-stage="location" data-id="location">Hobart</button>
                      </td>
                    </tr>
                    <tr>
                      <td class="animate-message-td" width="50%">
                        <button class="button animate-message-action-button" data-currentpath="loc" data-text="Melbourne" data-path="post-loc" data-stage="location" data-id="location">Melbourne</button>
                      </td>
                      <td class="animate-message-td" width="49%">
                        <button class="button animate-message-action-button" data-currentpath="loc" data-text="Sydney" data-path="post-loc" data-stage="location" data-id="location">Sydney</button>
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div data-w-tab="South East Queensland" class="w-tab-pane" style="opacity: 0; transition: opacity 300ms ease 0s;">
            <div class="location_ist_wrapper w-dyn-list">
              <div class="w-dyn-items w-row">
                ...
                <table class="animate-message-buttons-container">
                  <tbody>
                    <tr>
                      <td class="animate-message-td" width="50%">
                        <div>
                          <button class="button animate-message-action-button" data-currentpath="loc" data-text="Brookwater" data-path="post-loc" data-stage="location" data-id="location">Brookwater (Ipswich)</button>
                        </div>
                      </td>
                      <td class="animate-message-td" width="49%">
                        <div>
                          <button class="button animate-message-action-button" data-currentpath="loc" data-text="Capalaba" data-path="post-loc" data-stage="location" data-id="location">Capalaba</button>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td class="animate-message-td" width="50%">
                        <button class="button animate-message-action-button" data-currentpath="loc" data-text="Gold Coast" data-path="post-loc" data-stage="location" data-id="location">Gold Coast</button>
                      </td>
                      <td class="animate-message-td" width="49%">
                        <button class="button animate-message-action-button" data-currentpath="loc" data-text="North Lakes" data-path="post-loc" data-stage="location" data-id="location">North Lakes</button>
                      </td>
                    </tr>
                    <tr>
                      <td class="animate-message-td" width="50%">
                        <button class="button animate-message-action-button" data-currentpath="loc" data-text="Springwoods" data-path="post-loc" data-stage="location" data-id="location">Springwoods</button>
                      </td>
                      <td class="animate-message-td" width="49%">
                        <button class="button animate-message-action-button" data-currentpath="loc" data-text="Sunnybank" data-path="post-loc" data-stage="location" data-id="location">Sunnybank</button>
                      </td>
                    </tr>
                    <tr>
                      <td class="animate-message-td" width="50%">
                        <button class="button animate-message-action-button" data-currentpath="loc" data-text="Sunshine Coast" data-path="post-loc" data-stage="location" data-id="location">Sunshine Coast</button>
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div data-w-tab="Regional Queensland" class="w-tab-pane" style="opacity: 0; transition: opacity 300ms ease 0s;">
            <div class="location_ist_wrapper w-dyn-list">
              <div class="w-dyn-items w-row">
                ...
                <table class="animate-message-buttons-container">
                  <tbody>
                    <tr>
                      <td class="animate-message-td" width="50%">
                        <div>
                          <button class="button animate-message-action-button" data-currentpath="loc" data-text="Cairns" data-path="post-loc" data-stage="location" data-id="location">Cairns</button>
                        </div>
                      </td>
                      <td class="animate-message-td" width="49%">
                        <div>
                          <button class="button animate-message-action-button" data-currentpath="loc" data-text="Gladstone" data-path="post-loc" data-stage="location" data-id="location">Gladstone</button>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td class="animate-message-td" width="50%">
                        <button class="button animate-message-action-button" data-currentpath="loc" data-text="Hervey Bay" data-path="post-loc" data-stage="location" data-id="location">Hervey Bay</button>
                      </td>
                      <td class="animate-message-td" width="49%">
                        <button class="button animate-message-action-button" data-currentpath="loc" data-text="Mackay" data-path="post-loc" data-stage="location" data-id="location">Mackay</button>
                      </td>
                    </tr>
                    <tr>
                      <td class="animate-message-td" width="50%">
                        <button class="button animate-message-action-button" data-currentpath="loc" data-text="Rockhampton" data-path="post-loc" data-stage="location" data-id="location">Rockhampton</button>
                      </td>
                      <td class="animate-message-td" width="49%">
                        <button class="button animate-message-action-button" data-currentpath="loc" data-text="Toowoomba" data-path="post-loc" data-stage="location" data-id="location">Toowoomba</button>
                      </td>
                    </tr>
                    <tr>
                      <td class="animate-message-td" width="50%">
                        <button class="button animate-message-action-button" data-currentpath="loc" data-text="Townsville" data-path="post-loc" data-stage="location" data-id="location">Townsville</button>
                      </td>
                    </tr>
                  </tbody>
                </table>
      ...
      $('.tab_main').off().click(e => {
        let $el = $(e.target).hasClass('tab_main') ? $(e.target) : $(e.target).parent();
        $('.tab_main').removeClass('w--current')
        $el.addClass('w--current');
        $('.w-tab-pane').css('opacity', 0).removeClass('w--tab-active')
        let data = $el.data('w-tab')
        $(`.w-tab-pane[data-w-tab="${data}"]`).css('opacity', 1).addClass('w--tab-active')
...
var prepareSwitchRoute = path => {
  console.log('about to switch paths')
  aF.switchPath({ path })
  if (path === "loc") return initLocationStep();
  else return null;
}
...
// triggered after a new path is rendered
var parsePath = (p, d, props = {}) => {
  if (props.previous) aF.history.pop(); // remove the last option from the history if this was triggered by a back button
  // if there is more than 1 option in history, then show the back button
  if (aF.history && aF.history.length > 1) { // this makes sure the back button isnt show on the About You options
    $('.animate-message-inner').append(insertBackButton(p,d)); // add the back button
    $('.lime-back-btn-container').click(e => handleBack(e)); // add listeners to the back button
  }
}
...
var handleBack = e => {
  aF.history.pop(); // pop the latest option out of the history
  let path = aF.getPrevious(); // get the object of the previous path from aF
  handleSidebarReverse(path); // function to remove the options in the sidebar to match the step back
  let p = aF.history[aF.history.length - 1];
  aF.switchPath(aF.history[aF.history.length - 1], { previous: true }); // switches path, and also passes the previous boolean
  if (p.path === 'loc') initLocationStep();
}
